...
### 3년차 프론트엔드 엔지니어 김예림입니다.

 백엔드 개발로 시작했지만, 사용자 경험을 직접 구현하는 프론트엔드에서 진정한 흥미를 발견했습니다.  
 현재는 Vue, React 기반의 웹 애플리케이션 개발에 집중하고 있으며, AI 기술을 프론트엔드에 접목하는 것뿐만 아니라  
 AI 자체를 학습하여 개발 워크플로우에 효율적으로 활용하는 방법을 연구하고 있습니다.
